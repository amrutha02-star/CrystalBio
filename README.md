...
- Sales and Service visit pages must keep the existing app structure/navigation and the progressive Step 1 / Step 2 / Step 3 format. Enhancements should happen inside that structure: a quick field-visit assistant card, automatic agent/time/GPS reassurance, previous-entry/new-update controls, quick contact/equipment capture in Step 1, and simple office-action markers in Step 3.
