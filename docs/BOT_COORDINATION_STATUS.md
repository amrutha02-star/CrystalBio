...
- BUG-20260702-023 location/GPS remains the main active product issue. The bad Chrome-specific copy was removed live. Bloom's 2026-07-04 2:30 AM retest still saw `Location could not be captured` in the live mobile Sales path, while typed details were preserved and backend GPS validation worked. The issue is **not accepted** because Android/iPhone/Samsung/iPhone Chrome/Safari capture paths are not fully verified and 30-minute recent-GPS reuse needs owner review.
