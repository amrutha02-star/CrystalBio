...
14. FAIL — Agent checks in with selected work mode
...
18. FAIL — Sales Step 1 saves quick visit with GPS and follow-up
...
21. FAIL — Repeated Sales same-content save does not create duplicate latest rows
   - Evidence: {"status":201,"returnedVisitId":"sales_visit_998"}
22. FAIL — Service Step 1 saves quick service visit with GPS
...
29. FAIL — Agent submits leave request
