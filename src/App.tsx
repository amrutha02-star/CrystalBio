...
import { crystalBioFrontendApi, type FrontendAttendance, type FrontendLeaveRequest, type FrontendSalesSaveResult, type FrontendSalesNextAction, type FrontendSession } from './crystalBioFrontendApi';
  ...
  const renderSales = () => (
    <ScreenPanel notice={screenNotice} title="Sales visit" subtitle="Save today’s customer update with GPS.">
      <div className="form-card highlighted-card">
        ...
        <p>Location permission is requested when this update is saved.</p>
      </div>
